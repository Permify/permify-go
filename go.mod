...
require (
	buf.build/gen/go/permifyco/permify/protocolbuffers/go v1.34.2-20240930153438-5bdb051ac145.2
...
require (
	buf.build/gen/go/permifyco/permify/grpc/go v1.5.1-20240930153438-5bdb051ac145.1
